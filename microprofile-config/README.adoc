...
include::../shared-doc/xp-import-imagestreams-templates.adoc[leveloffset=+1]
// Deploy the {ProductShortName} Source-to-Image (S2I) Quickstart to OpenShift
include::../shared-doc/cd-deploy-project.adoc[leveloffset=+1]

== Alternative to consider

Copy & adapt content from https://access.redhat.com/documentation/en-us/red_hat_jboss_enterprise_application_platform/7.3/html-single/getting_started_with_jboss_eap_for_openshift_container_platform/index#build_run_java_app_s2i for this quickstart instead of kitchensink?
...
where `${version.microprofile.bom}` is the full version of your {productName}.
