...
:quickstartDownloadName: Red Hat JBoss Enterprise Application Platform expansion pack {productVersion} Quickstarts
...
:ImageandTemplateImportURL: https://raw.githubusercontent.com/jboss-container-images/jboss-eap-openshift-templates/eap-xp1/templates/
